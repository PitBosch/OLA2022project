...
class Environment:
    ...
    def user_profit(self, user, price_combination, product_index):
        ...
        if ((not(user.buy(self.products[product_index].prices[price_combination])) or len(user.visited_products)==5)):
            return margin
    ...
    def simulate_day(self, users_number, users_probs, price_combination): #TODO USER PROBS DA TOGLIERE
        ...
        # Generate di alpha ratio for each user category for the new day
    ...
    def exp_return(self, primary: Product, primary_history: set[Product], q_link : list[float], link: list[Product], price_combination, user: UserCat):
    ...
    def aggregated_reward(self, price_combination):
        ...
        for user_cat in self.users:
            ...
            for product in self.products:
                ...
                user_regret += alpha_i * self.exp_return(product, {"a"}, [0], [Product([], -1, "null", [])], price_combination, user_cat)
    ...
    def single_reward(self, user: UserCat, price_combination):
    ...
    def optimal_reward(self, user_index = -1):
        ...
        for price_combination in possible_combinations:       
            ...
            if user_index == -1:
                ...
                regret = self.single_reward(self.users[user_index], price_combination)
